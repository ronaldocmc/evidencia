...
<body>
	<div class="container vh-100">
		<div class="col-md-4 offset-md-4" style="margin-top: 50px">
			...
			<form class="form" method="POST" id="form" action="<?php echo base_url('contact/first_login/' . $token) ?>">

				<div class="col-md-12">
					<label for="login">Login</label>
					<input type="email" id="login" name="login" class="form-control" required>
					<div class="input-group-append">
						<span class="input-group-text" id="basic-addon2">@admin.com</span>
					</div>
					<small id="loginHelperBlock" class="form-text text-muted"></small>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<label for="new_password_repeat">Repita a senha</label>
