                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-user-guide">
                                    <div class="col-md-6">
                                        ...
                                        <p> Aqui você poderá realizar algumas operações para controlar os departamentos
                                            da sua organização.</p><br>
                                        <p>Organizamos o seu departamento de modo que ele possua serviços específicos
                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                <div class="col col-md-2">
                                    <label for="departamento_nome"
                                        class=" form-control-label"><strong>Nome*</strong></label>
                                </div>
                                <div class="col-12 col-md-10">
                                    <input type="text" id="departamento_nome" name="nome"
                                        placeholder="Nome do Departamento" class="form-control" required="true"
