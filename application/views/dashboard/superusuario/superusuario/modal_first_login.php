                            ...
                            <div class="card card-step col-12 px-0">
                                ...
                                <div class="card-body card-block">
                                    <div class="row form-group">
                                        <div class="col-12">
                                            <p>Para acessar o sistema, você utilizará a sintaxe <b><span class="login">login</span>@admin</b></p>
                                        </div>
                                        <div class="col-12 col-md-2">
                                            <label for="login-input" class=" form-control-label"><strong>Login*</strong></label>
                                        </div>
                                        <div class="col-12 col-md-10">
                                            <input type="text" id="login-input" name="email" placeholder="Login" class="form-control" required="true" min-lenght="3" max-lenght="60">
                            ...
                            <div class="card card-step col-12 px-0">
                                ...
                                <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-10">
                                                <input type="password" id="senha-input" name="senha-input" placeholder="senha" class="form-control" required="true" minlength="8">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-10">
                                                <input type="password" id="confirme-senha-input" name="confirme-senha-input" placeholder="Confirme a senha" class="form-control" required="true" minlength="8">
                            ...
                            <div class="card card-step col-12 px-0">
                                ...
                                <div class="card-body card-block">
                                    <div class="row form-group" style="text-align: center !important;">
                                        ...
                                        <p>Login: <span class="login"></span>@admin</p>
                                        <p><blockquote>"Grandes poderes trazem grandes responsabilidades."</blockquote></p>
                                    </div>
                                </div>
                                <div class="card-footer text-center">
                                    <button type="button" class="btn btn-secondary previous btn-sm">
